...
function EditStage() {
  ...
  useEffect(() => {
    if (leadPermission) {
      if (leadPermission?.meeting_stages?.active_module === "0" || leadPermission?.meeting_stages?.edit === "0") {
  ...
  useEffect(() => {
    if (res.data) {
      ...
      navigate(`/${config.ddemoss}meeting/${pipeline_id}/Kanban`)
    }
          ...
          <div className="col-12">
            <div className="card">
              ...
              :
                          ...
                          <Field required={true} as="select" name="order_number" className="form-control my-1" value={initialValues.order_number}
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="text-right"> <Link to={`/${config.ddemoss}meeting_pipelines/${item.pipeline_id}/edit_stage/${item.id}`} className="text-info">
                        ...
                        <span className='margin_gap' onClick={() => handleDeleteStage(item)}> <i className="fa-regular fa-trash-can pointer"></i> </span>
                      </td>
                    </tr>
                  )
                }) : <tr>
