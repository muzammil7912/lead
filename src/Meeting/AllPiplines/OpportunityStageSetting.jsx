...
const handleDelete = (item) => {
  ...
  swal({
    ...
    if (willDelete) {
      apiMethod(`postDeleteOpportunityStagesSettings`, bodyContent);
...
function handleSaveSettings() {
  ...
  formdata.append("pipeline_stage", "7");
  ...
  formdata2.append("position[won]", StagesWon);
  formdata2.append("position[lost]", StagesLost);
  formdata2.append("general", "pipeline_stage_wonlost");
  formdata2.append("pipeline_stage", "7");
  formdata.append("pipeline_stage_positions", 'stG-WL');
  let bodyContent2 = formdata2;
  apiMethod2("postUpdateOpportunityStagesConditions", bodyContent2);
}
function handleSubmit() {
  ...
  if(textinput.current.value==""){
    ...
    let bodyContent = formdata;
    apiMethod("postCreateOpportunityStagesSettings", bodyContent);
    handleAPi()
  }
}
