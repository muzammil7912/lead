...
function EditMeetingPriority() {
    ...
    const { data: EditPriority, loading, error } = useFetch({ setDatas }, `getEditMeetingPriority/${id}`);
    ...
    useEffect(() => {
        if (res.data && !res.isLoading) {
            ...
            navigate(`/${config.ddemoss}meeting_priority`);
        }
    }, [res.data]);
        ...
        <div className="container-fluid">
            <div className="row clearfix my-4">
                <div className="col-4 offset-sm-4">
                                ...
                                <div className="card-body mb-0">
                                    <div className="col-md-12 mt-1">
                                        <div className="form-group">
                                            ...
                                            <Field type="text" className="form-control my-1" name="status_name" placeholder={Translation(translations, "Priority Name...")} />
                                        </div>
                                        <div className="">
                    ...
                    <p className="text-center my-4"><Link to={`/${config.ddemoss}meeting_priority`}> Go to Priority</Link></p>
                </div>
            </div>
        </div>
    )
