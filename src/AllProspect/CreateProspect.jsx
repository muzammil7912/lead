...
import defaults3 from "../dist/webImages/profile.png";
...
import { handle_update_statistics } from "../components/AllCustomFuntion";
...
function CreateProspect() {
  ...
  const { data: prospect_lead_stage, loading8, error8, } = useFetch("", "getAllProspectCreateProspect");
  const { data: stageData, loading, error } = useFetch("", "getViewProspectKanbanStages");
  ...
  useEffect(() => {
    if (leadPermission) {
      if (leadPermission?.prospects?.active_module == "0" || leadPermission?.prospects?.create == "0") {
  ...
  function handleSubmit(values) {
    ...
    if (!timeZone || loading3 || respremetion.isLoading || res3.isLoading || loading) return <Loader />

    if (emails == '') {
      if (leadPermission?.super_admin == true || leadPermission?.prospects?.fields?.prospects_email == "true") {
        req.push('email')
      }
    }
    ...
    if (emailse) {
      ...
      formdata.append("prospect_stage", Stage);
      formdata.append("lead_stage", prospect_lead_stage && prospect_lead_stage.Id);
      formdata.append("submit", "create_prospect");

      let bodyContent = formdata;
      apiMethod("postCreateProspect", bodyContent);
  ...
  useEffect(() => {
    if (selectedSource) {
      if (leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_lead_medium === "true") {
  ...
  if (respremetion.isLoading || res3.isLoading || loading) return <Loader />

  if (leadPermission?.super_admin == true || leadPermission?.prospects?.fields?.prospects_fname == "true") {
  }
  else {
    reqName.splice(reqName.indexOf("fname"), 1)
  }
  if (leadPermission?.super_admin == true || leadPermission?.prospects?.fields?.prospects_lead_source == "true") {
  }
  else {
    reqName.splice(reqName.indexOf("leadsource"), 1)
    reqName.splice(reqName.indexOf("lead_leadmedium"), 1)
  }
  if (leadPermission?.super_admin == true || leadPermission?.prospects?.fields?.prospects_lead_medium == "true") {
  }
  else {
    reqName.splice(reqName.indexOf("lead_leadmedium"), 1)
  }
  if (leadPermission?.super_admin == true || leadPermission?.prospects?.fields?.prospects_contact_type == "true") {
  }
  else {
  ...
  return (
    <div className="container-fluid">
      {console.log(leadPermission?.prospects?.fields)}
      <Formik
              ...
              <div className="card">
                ...
                <div className="card-header borderblue">
                  <h3 className="card-title">
                    {Translation(translations, "New Prospect")}
                  </h3>
                ...
                <div className="card-body">
                  <div className="row fv-plugins-icon-container">
                    <div className="col-md-6">
                      {
                        leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_fname === "true" ?
                      ...
                      {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_lname === "true" ?
                        <FormControl
                          className="form-control my-1"
                        ...
                        /> : ''}
                      {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_contact_type === "true" ?
                        <FormControl
                          className="form-control my-1"
                          firstSelect={"--Select--"}
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_avtar === "true" ?
                      <div className="col-md-6"   >
                        <File
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_email === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                          required={true}
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_email_status === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_lead_stage === "true" ?
                      <div className="col-md-6">
                        ...
                        <FormControl
                          ...
                          name={"lead_stage"}
                          control="input"
                          value={prospect_lead_stage && prospect_lead_stage.Value}
                          disabled
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_phone_number === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                          updatess={(item) =>
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_mobile_phone === "true" ?
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_birthday === "true" ?
                      <div className="col-md-6 mt-3">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_tags === "true" ?
                      <div className="col-md-6">
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_score_number === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                          type={"number"}
                  ...
                  <div className="row">
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_address1 === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_address2 === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_city === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_postal_code === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_state === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_country === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_ipaddress === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_time_zone === "true" ?
                      <div className="col-md-6">
                        <div className="form-group row">
                          ...
                          <Dropdown5
                            list={Array.isArray(timeZone) && timeZone}
                            changes={(value) => setPracticeName(value)}
                            selected={practiceName}
                          />
                        </div>
                      </div> : ''}
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_locale === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_sourcepage === "true" ?
                      <div className="col-md-6">
                        <FormControl
                          className="form-control my-1"
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        {leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_lead_source === "true" ?
                          leadPermission?.super_admin || leadPermission?.prospects?.fields?.prospects_lead_medium === "true" ? <div>
                            <FormControl
                              className="form-control my-1"
                                            ...
                                            return (
                                              <div key={ii} >
                                                ...
                                                {Object.keys(editLeadFeild.all_fields[key][key2]).map(function (key3, j) {
                                                  ...
                                                  let labelName = `prospects_${label.replaceAll(' ', '_')}`
