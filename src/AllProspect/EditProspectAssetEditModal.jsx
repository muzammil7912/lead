...
function EditLeadAssetEditModal({
  ...
  useEffect(() => {
   if(showEditModal){ subbb(item.file_category.split(','))
    ...
    if (item.file_followers != "") {
      ...
      if (resowner.data && !resowner.data.message) {
        ...
        if (a.length) {
          ...
          setdefaultValueOfCustom_selected_Follower(nameobj_of_follower)
  ...
  useEffect(()=>{
    ...
    if(resPostCategory.data &&!resPostCategory.data.message){
      let subData= (resPostCategory.data).map((val,index)=>{return{
      value:  val.cat_id,
      label: val.cat_name,
      }})
      ...
      <Modal show={showEditModal} onHide={handleEditModalClose}>
        ...
        <Modal.Body>
          ...
          {followerSelectValue == 'Custom' && <div >
            ...
            <Select mode="multiple"
              ...
              defaultValue={defaultValueOfCustom_selected_Follower && defaultValueOfCustom_selected_Follower}
            >

              {resowner.data && !resowner.data.message && resowner.data.map(({ uname, id, text }) => (
          ...
          {followerSelectValue == 'Role' &&
            <div>
              ...
              <select
                ...
                // value={"4"}
                onChange={(e) => setselectedFollowerRole(e.target.value)} >
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            variant="primary" className='d-flex justify-content-center align-item-center' onClick={() => { handleEditModalClose(); submitEditUpdate(item) }}>
