...
export default function Status({ translation }) {
  ...
  const { data: getStatusData, loading, error } = useFetch('', 'getAllViewProjectsStatus')
  ...
  const handleSubmit = (value, { resetForm }) => {
    ...
    if (value['status_name'] === '') {
      ...
      apiMethod('postCreateProjectsStatus', formData);
      resetForm();
    }
  }
  useEffect(() => {
  ...
  const handleDelete = (item) => {
    ...
    swal({
      ...
      if (willDelete) {
        apiMethoddelete(`postDeletedProjectsStatus`, deleteData);
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td className="text-right">
                              ...
                              >
                                <Link to={`/${config.ddemoss}projects_status/edit/${item.status_id}`} className="btn btn-icon vstg" style={{ backgroundColor: '#fff' }}>
