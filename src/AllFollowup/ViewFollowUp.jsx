...
const ViewFollowUp = ({ translation }) => {
    const { id } = useParams();
    ...
    const {
        ...
        loading,
        error,
    } = useFetch('', `getEditPiplineEvent/${id}`);
    ...
    useEffect(() => {
        if (viewAction && !viewAction.message) {
            ...
            setMember(viewAction?.followersData)
            setFollower(viewAction?.membersData)
        }
    }, [viewAction]);
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div className="card">
                                ...
                                <div className="card-header">
                                    <h3 className="card-title">
                                        {" "}
                                        {Translation(translation, "Related To Contact")}{" "}
                                    </h3>
