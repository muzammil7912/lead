...
function Automation_addTag_module({children,setshow1 ,module_name,handle_add_contact_tag,backgroundColor}) {
    const InitialSameModal = {
        tag_to_add_contact: "",
      };
    const [automation_addTag_module, setAutomation_addTag_module] = useState(false)

  return (
   <>
   <span onClick={()=>{setAutomation_addTag_module(true)}}>
   {children}
   </span>
    <Modal
      ...
      >
        <Formik
          ...
          onSubmit={(value)=>{
              handle_add_contact_tag(value,setAutomation_addTag_module,module_name,backgroundColor)
            //   setshow1(false);
            }}
          ...
          <Form name="myForm">
            <Modal.Header closeButton>
              <Modal.Title id="contained-modal-title-vcenter">
                <h5 className="modal-title">{module_name} add tags</h5>
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className="row">
...
export default Automation_addTag_module