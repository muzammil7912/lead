...
import { PrivilegesAction } from '../../Data/AllData';

function EditProfileActions({ data, useIDD, reCallAPI }) {
    ...
    function handleGet() {
        ...
        OpportunitiesData.append("module", "Action");
        OpportunitiesData.append("event_type", "action");
	...
	const handleFunction = (e, setFieldValue) => {
		...
		let checkBox_name=["mod_view",'active_module','mod_create','mod_edit','mod_delete','actions_pip_Inbound_Call','actions_pip_Whatsapp','actions_pip_eMail','actions_pip_Standard_Meetings','actions_pip_Risks','actions_pip_Issues','actions_pip_Decisions','actions_pip_Outbound_Call','actions_pip_General','actions_pip_new_test','actions_pip_To_Do_List','actions_pip_Concierge','actions_pip_Follow_Up','actions_pip_Tickets','actions_pip_New_Public','actions_admininfo','actions_admin_create_date','actions_admin_updated_date','actions_admin_prjstage_dates','actions_stage_create','actions_stage_view','actions_stage_edit','actions_stage_delete','actions_stage_setting','actions_pipeline_create','actions_pipeline_view','actions_pipeline_edit','actions_pipeline_delete']
    ...
    function handleSubmit(values) {
        ...
        formdatas.append("module", "action");
                    ...
                    <Form name="myForm">
                        ...
                        <div className="row">
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_title} name={"actions_title"} dataprop={"Title"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_priority} name={"actions_priority"} dataprop={"Priority"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_calendar} name={"actions_calendar"} dataprop={"Calendar"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_color} name={"actions_color"} dataprop={"Action Color"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_pipeline} name={"actions_pipeline"} dataprop={"Pipeline"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_stage} name={"actions_stage"} dataprop={"Stage"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_location} name={"actions_location"} dataprop={"Location"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_start_date} name={"actions_start_date"} dataprop={"Start Date"} />
                                </div>
                            </div>
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_start_date_time} name={"actions_start_date_time"} dataprop={"Start Time"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_end_date} name={"actions_end_date"} dataprop={"End Date"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_end_date_time} name={"actions_end_date_time"} dataprop={"End Time"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_time_zone} name={"actions_time_zone"} dataprop={"Time Zone"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_related_to} name={"actions_related_to"} dataprop={"Related To"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_has_dependency} name={"actions_has_dependency"} dataprop={"Dependency"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_all_day} name={"actions_all_day"} dataprop={"All Day Event"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_recursive_event} name={"actions_recursive_event"} dataprop={"Recursive Options"} />
                                </div>
                            </div>
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_privacy} name={"actions_privacy"} dataprop={"Privacy"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_visibility} name={"actions_visibility"} dataprop={"Visibility"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_google_meet} name={"actions_google_meet"} dataprop={"Google Meet"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_meeting_platform} name={"actions_meeting_platform"} dataprop={"Meeting Platform"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_description} name={"actions_description"} dataprop={"Description"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_notification} name={"actions_notification"} dataprop={"Notification"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_feature_image} name={"actions_feature_image"} dataprop={"Feature Image"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.actions_members} name={"actions_members"} dataprop={"Members"} />
                                </div>
                            </div>
