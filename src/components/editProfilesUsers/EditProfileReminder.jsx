...
import { PrivilegesReminder } from '../../Data/AllData';

function EditProfileReminder({ data, useIDD, reCallAPI }) {
    ...
    function handleGet() {
        ...
        OpportunitiesData.append("module", "Reminder");
        OpportunitiesData.append("event_type", "reminder");
    ...
    function handleSubmit(values) {
        ...
        formdatas.append("module", "reminder");
                    ...
                    <Form name="myForm">
                        ...
                        <div className="row">
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_title} name={"reminder_title"} dataprop={"Title"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_priority} name={"reminder_priority"} dataprop={"Priority"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_calendar} name={"reminder_calendar"} dataprop={"Calendar"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_color} name={"reminder_color"} dataprop={"reminder Color"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_pipeline} name={"reminder_pipeline"} dataprop={"Pipeline"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_stage} name={"reminder_stage"} dataprop={"Stage"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_location} name={"reminder_location"} dataprop={"Location"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_start_date} name={"reminder_start_date"} dataprop={"Start Date"} />
                                </div>
                            </div>
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_start_date_time} name={"reminder_start_date_time"} dataprop={"Start Time"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_end_date} name={"reminder_end_date"} dataprop={"End Date"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_end_date_time} name={"reminder_end_date_time"} dataprop={"End Time"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_time_zone} name={"reminder_time_zone"} dataprop={"Time Zone"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_related_to} name={"reminder_related_to"} dataprop={"Related To"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_has_dependency} name={"reminder_has_dependency"} dataprop={"Dependency"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_all_day} name={"reminder_all_day"} dataprop={"All Day Event"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_recursive_event} name={"reminder_recursive_event"} dataprop={"Recursive Options"} />
                                </div>
                            </div>
                            <div className="col-sm-4 col-md-4">
                                <div>
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_privacy} name={"reminder_privacy"} dataprop={"Privacy"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_visibility} name={"reminder_visibility"} dataprop={"Visibility"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_google_meet} name={"reminder_google_meet"} dataprop={"Google Meet"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_meeting_platform} name={"reminder_meeting_platform"} dataprop={"Meeting Platform"} />
                                </div>

                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_description} name={"reminder_description"} dataprop={"Description"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_notification} name={"reminder_notification"} dataprop={"Notification"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_feature_image} name={"reminder_feature_image"} dataprop={"Feature Image"} />
                                </div>
                                <div className="mt-2">
                                    <ProfileCheckbox updateClick={(item) => handlevalUpdate(item)} datas={initialValues.reminder_members} name={"reminder_members"} dataprop={"Members"} />
                                </div>
                            </div>
