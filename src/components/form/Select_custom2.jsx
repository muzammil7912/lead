...
function Select_Custom_Options2({ name, required, defaultValue, label, selectedd, selectList, Changes, firstSelect, custom_label_name, customer_value_name, ...rest }) {
...
export default Select_Custom_Options2